...
<div class="form-container">
    <form action="{{ route('coupon.update',$coupon->coupon_id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input value="{{ $coupon->discount_value }}" placeholder="Discount Value:" type="number" id="discount_value" name="discount_value" step="0.01" required>
        </div>

        <!-- Max Discount Value (optional) -->
        <div class="form-group">
            <label for="max_discount_value">Max Discount Value (optional):</label>
            <input value="{{ $coupon->max_discount_value }}" placeholder="Max Discount Value (optional):" type="number" id="max_discount_value" name="max_discount_value" step="0.01">
        </div>
        ...
        <div class="form-group">
            ...
            <input value="{{ $coupon-> usage_limit}}" placeholder="Usage Limit:" type="number" id="usage_limit" name="usage_limit" required>
        </div>
