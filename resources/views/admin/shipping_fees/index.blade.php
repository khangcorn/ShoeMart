...
<div class="px-4 py-4">
    <div class="flex items-center justify-between">
        <a class="inline-block duration-300 rounded-lg border border-indigo-600 bg-indigo-600 px-6 py-2 text-sm font-medium text-white focus:ring-3 focus:outline-hidden" href="{{ route('shipping-fees.create') }}">Add New Shipping-fee</a>
            ...
            <table class="w-full ">
                <thead >
                    <tr >
                        ...
                        <th class="px-2 py-5 border border-gray-300 text-center font-semibold">Province</th>
                        <th class="px-2 py-5 border border-gray-300 text-center font-semibold">District</th>
                        <th class="px-2 py-5 border border-gray-300 text-center font-semibold">Ward</th>
                        <th class="px-2 py-5 border border-gray-300 text-center font-semibold">Fee</th>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr >
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">{{  $fee->shipping_id }}</td>
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">{{   $fee->province }}</td>
                       
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">{{ $fee->district ?? '-' }}</td>
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">{{ $fee->ward ?? '-' }}</td>
                   
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">{{ number_format($fee->fee, 0, ',', '.') }}</td>
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">
                            <div class="flex justify-center items-center gap-2">
                                <a href="{{ route('shipping-fees.edit', $fee->shipping_id) }}"
                                    ...
                                    <form action="{{ route('shipping-fees.destroy', $fee->shipping_id) }}" method="POST" 
                                        onsubmit="return confirm('Are you sure you want to delete this shipping fee?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                    ...
                    @empty
          <tr>
            <td colspan="6" class="w-full py-4 text-center flex justify-center text-gray-500">No shipping fee found.</td>
