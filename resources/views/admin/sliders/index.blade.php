...
@endif
    <div class="px-4 py-4">
        <div class="flex items-center justify-between">
            <a class="inline-block duration-300 rounded-lg border border-indigo-600 bg-indigo-600 px-6 py-2 text-sm font-medium text-white focus:ring-3 focus:outline-hidden" href="{{ route('sliders.create') }}">Add New Slider</a>
            ...
            <table class="w-full">
                <thead >
                    <tr >
                        ...
                        <th class="px-2 py-5 border border-gray-300 text-center font-semibold">Caption</th>
                        <th class="px-2 py-5 border border-gray-300 text-center font-semibold">Link</th>
                        <th class="px-2 py-5 border border-gray-300 text-center font-semibold">Position</th>
                ...
                <tbody >
                    ...
                    <tr >
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">{{ $slider->slider_id }}</td>
                        ...
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">{{ $slider->caption }}</td>
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">
                            <a href="{{ $slider->link }}" target="_blank" class="text-blue-600 hover:underline">
                                {{ Str::limit($slider->link, 30) }}
                            </a>
                        </td>
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">{{ $slider->position }}</td>
                        <td class="border border-gray-300 dark:border-gray-700 px-2 py-5 items-center text-center">
