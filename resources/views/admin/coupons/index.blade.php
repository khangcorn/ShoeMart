                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @forelse($coupons as $coupon)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 border text-gray-700">{{ $coupon->usage_limit }}</td>
                            <td class="px-4 py-3 border text-gray-700">{{ $coupon->usage_count }}</td>
                            <td class="px-4 py-3 border text-gray-700">{{ number_format((int) $coupon->min_order_value, 0, ',', '.') }}₫</td>
                            <td class="px-4 py-3 border text-gray-700">{{ $coupon->expiration_date_formatted }}</td>
