...
@section('content')
    ...
    <div class="container mx-auto p-6">
        ...
        <div>
            ...
            <div>
                ...
                <select
                    class="text-black w-full mt-1 p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 @error('category_id') border-red-500 @enderror"
            ...
            <div>
                <label for="product_images" class="block text-sm font-medium text-gray-700 mb-2">Hình Ảnh Sản Phẩm
                    Chính</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const productStockField = document.getElementById(
            'product_stock_input'); // Lấy phần tử input số lượng sản phẩm
            let variantIndex = 0;
                ...
                variants.forEach(variant => {
                    ...
                    if (color && size) {
                        ...
                        if (colorSizePairs.includes(pair)) {
                            showError(variant.querySelector('.variant-color'),
                                'Màu và Kích cỡ này đã tồn tại');
                            showError(variant.querySelector('.variant-size'),
                                'Màu và Kích cỡ này đã tồn tại');
                            isValid = false;
                        } else {
                    ...
                    let effectivePrice = salePrice.value !== '' && parseFloat(salePrice.value) > 0 ?
                        parseFloat(salePrice.value) : parseFloat(price.value);
