            ...
            <ol class="flex justify-center gap-1 text-xs font-medium">
                ...
                <li>
                    <a href="{{ $products->previousPageUrl() }}"
                        class="inline-flex  size-8 items-center justify-center rounded-lg border   border-gray-300  bg-white text-gray-900 {{ $products->onFirstPage() ? 'opacity-50 pointer-events-none' : '' }}">
                    ...
                    @else
                        <li>
                            <a href="{{ $products->url($i) }}"
                                class="block  size-8 rounded-lg border    border-gray-300 bg-white text-center leading-8 text-gray-900 hover:bg-gray-200">
                                {{ $i }}
                            </a>
                        </li>
                    @endif
                ...
                <li>
                    <a href="{{ $products->nextPageUrl() }}"
                        class="inline-flex  size-8 items-center justify-center rounded-lg  border border-gray-300   bg-white text-gray-900 {{ $products->hasMorePages() ? '' : 'opacity-50 pointer-events-none' }}">
