...
@section('content')
    <div class="container mx-auto p-6">
        <h1 class="text-3xl font-bold mb-6">Thêm Thuộc Tính</h1>

        <form action="{{ route('variant_attributes.store') }}" method="POST">
            @csrf
            <div>
                ...
                <input type="text" id="attribute_name" name="attribute_name"
                    class="text-black w-full p-2 border rounded-lg @error('attribute_name') border-red-500 @enderror" value="{{ old('attribute_name') }}">
            ...
            <div>
                ...
                <input type="text" id="attribute_value" name="attribute_value"
                    class="text-black w-full p-2 border rounded-lg @error('attribute_value') border-red-500 @enderror" value="{{ old('attribute_value') }}">
