...
<div class="py-4 px-4">   
    <h2 class="text-3xl font-bold mb-6">Danh sách màu sắc </h2> 
    <div class="flex items-center justify-between">
        <a class="inline-block duration-300 rounded-lg border border-indigo-600 bg-indigo-600 px-6 py-2 text-sm font-medium text-white focus:ring-3 focus:outline-hidden" href="{{ route('colors.create') }}">Thêm mới màu sắc</a>
...
<div class="py-2"></div>
            <table class="w-full ">
                <thead>
                    <tr >
                        <th class="px-2 py-5 border border-gray-300 text-center font-semibold">Màu sắc</th>
                ...
                <tbody>
                    @foreach ($colors as $color)
                        <tr>
                            <td class="border border-gray-300  px-2 py-5 items-center text-center">{{ $color->attribute_value }}</td>
