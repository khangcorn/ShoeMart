...
<div class="py-4 px-4"> 
    <h2 class="text-3xl font-bold mb-6">Danh sách kích thước</h2> 
    <div class="flex items-center justify-between">
        <a class="inline-block duration-300 rounded-lg border border-indigo-600 bg-indigo-600 px-6 py-2 text-sm font-medium text-white focus:ring-3 focus:outline-hidden" href="{{ route('sizes.create') }}">Thêm mới kích thước</a>
            ...
            <table class="w-full">
                ...
                <tbody>
                    @foreach ($sizes as $size)
                        <tr >
                            <td class="border border-gray-300  px-2 py-5 items-center text-center">{{ $size->attribute_value }}</td>
